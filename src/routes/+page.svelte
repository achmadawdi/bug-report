...
<div class="mx-auto flex min-h-[calc(100vh-2.5rem)] max-w-4xl flex-col items-center justify-center gap-8 px-6 py-16">
	...
	<div class="grid w-full gap-3 sm:grid-cols-2">
		...
		<button type="button" class="text-left" onclick={openCreateDialog}>
			...
			>
				<CardContent class="flex flex-col items-center gap-2 p-4 text-muted-foreground">
					<div class="flex size-10 items-center justify-center rounded-full border border-dashed border-border">
